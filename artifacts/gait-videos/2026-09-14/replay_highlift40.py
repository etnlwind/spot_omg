...
from shoulder_j2_highlift_preview import configure
geometry=configure(r);print('GEOMETRY',geometry,flush=True)
out=Path(__file__).with_name('shoulder-j2-highlift40-four-views-fixed-line-center.mp4')
  ...
  if i%2==0:
   if i<1500:
    ...
    for x,y,label in [(12,0,'SIDE'),(972,0,'TOP'),(12,540,'REAR'),(972,540,'QUARTER')]:
     draw.rectangle((x-4,y+8,x+600,y+65),fill='black');draw.text((x,y+17),f'{label} | {t:05.2f}s | '+('IDLE' if t<10 else 'FORWARD 100% / LIFT 40mm'),fill='white')
