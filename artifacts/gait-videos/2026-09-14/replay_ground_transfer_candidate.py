...
config=json.loads((ROOT/'simulation/mujoco/ground_transfer_candidate.json').read_text())['config']
geometry=configure(r,config);print('GEOMETRY',geometry,flush=True)
out=Path(__file__).with_name('ground-transfer-candidate-four-views.mp4')
