...
PROFILE = dict(V61_PROFILE, params=[2.0, .5, .145, .012], rear_extension_m=.105,
               reverse_input_limit=.6, continuous_recovery=True, stop_period_s=1.6)
PROFILES = {'s_native_v1': V1_PROFILE, 's_native_v2': V2_PROFILE,
            ...
            's_native_v6_1': V61_PROFILE, NAME: PROFILE}
