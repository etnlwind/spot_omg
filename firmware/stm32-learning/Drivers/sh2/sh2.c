...
// LOCAL CHANGE (spot_omg): added timeout_us.
// Upstream leaves it 0, which makes opProcess() spin forever when the part
// never answers, hanging the firmware at boot instead of reporting a fault.
// See Drivers/sh2/LOCAL_CHANGES.md.
