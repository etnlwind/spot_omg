...
static inline void joint_trace_sample(JointTrace *t,JointTraceSample sample) {
    ...
    if(t->sample_count>=JOINT_TRACE_CAPACITY){t->armed=false;t->full=true;return;}
