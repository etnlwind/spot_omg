...
```sh
/opt/anaconda3/envs/spot_omg/bin/mjpython simulation/mujoco/virtual_robot.py --viewer --no-ble --no-video --host 127.0.0.1 --port 8875 --experimental-profiles simulation/mujoco/config/upright_profiles.json --profile cushion_diagonal_sync_wide80 --foot-cushion simulation/mujoco/config/foot_cushion_d37p3_l27mm.json
```
