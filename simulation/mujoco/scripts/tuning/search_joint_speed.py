...
ROOT=REPO_ROOT
OUT=ROOT/'artifacts/simulation/mujoco/diagnostics/joint-speed'
...
if __name__=='__main__':
    ...
    specs=[(1.4,.065,.015)]+[(p,s,.015) for p in (1.,1.15,1.25) for s in (.065,.08,.095)]+[(1.15,.08,.018),(1.25,.095,.018)]
    for n,(period,stride,height) in enumerate(specs):
