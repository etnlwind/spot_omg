...
ROOT=REPO_ROOT
OUT=ROOT/'artifacts/simulation/mujoco/diagnostics/joint-sport'
...
if __name__=='__main__':
    ...
    specs=[(period,duty,stride) for period in (1.2,1.35,1.5) for duty in (.55,.59) for stride in (.085,.095)]
