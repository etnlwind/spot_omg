...
SOURCE_FILES = ['runtime/support_shift.py', 'runtime/virtual_robot.py', 'runtime/cad_physics.py',
                'runtime/bno055_emulator.py', 'runtime/position_wbc.py', 'cad_300mm/physics_parameters.json']
