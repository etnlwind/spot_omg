...
SOURCE=['runtime/dynamics_wbc.py','runtime/centroidal_preview.py','runtime/support_shift.py','runtime/virtual_robot.py',
        'runtime/cad_physics.py','runtime/bno055_emulator.py','config/foot_cushion_d37p3_l27mm.json','config/upright_profiles.json']


def trial(job):
    name,scenario,overrides,seconds,stop=job
    cfg=copy.deepcopy(json.loads((ROOT/'config/upright_profiles.json').read_text())['profiles']['cushion_dynamics_wbc80'])
