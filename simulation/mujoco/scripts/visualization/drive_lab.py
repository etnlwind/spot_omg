...
from simulation.mujoco.runtime.walk import CONFIG, SCENE, LEGS, initialize_on_ground, root_position, body_up_z, read_imu, ground_contact_legs
...
def main():
    ...
    if not args.check and platform.system() == 'Darwin' and 'MJPYTHON_BIN' not in os.environ:
        raise RuntimeError('Use mjpython simulation/mujoco/scripts/visualization/drive_lab.py on macOS')
