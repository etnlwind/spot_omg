...
from simulation.mujoco.scripts.validation.validate_support_shift import Recorder
...
def evaluate(name):
    ...
    result,rows=run(1000,0,20.02,profile=name,override=cfg,
        cushion=json.loads((ROOT/'config/foot_cushion_d37p3_l27mm.json').read_text()),observer=rec)
