...
2026-09-23부터 보행 ACC 기본 요청은 전 축254입니다. 실제 가속도 측정값은 아니며
실기 readback과 하중 응답은 미검증입니다. 과거 J1/J3=50, J2=254 조건 재현은
`servo_acceleration_cap_register=[50,254,50]*4`로 명시합니다.
[변경 및 실패한 V10 시험 기록](../../docs/ACC254-2026-09-23.md)을 참고하세요.
