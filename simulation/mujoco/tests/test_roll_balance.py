...
from simulation.mujoco.runtime.walk import CONFIG, LEGS, SCENE, SIM_PRESETS, canonical_targets_to_positions, initialize_on_ground, parse_args, read_imu, resolve_gait, set_controls, stance_targets


def test_trot3_simulator_uses_the_same_rebalanced_full_mode_defaults(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(sys, "argv", ['runtime/walk.py', "--preset", "trot3"])
    args = parse_args()
    resolve_gait(args)
