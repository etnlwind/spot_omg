...
import numpy as np
from simulation.mujoco.scripts.visualization.stow_preview import make_plant, STAGES
...
def test_overhead_path_stops_before_original_overlap_orientation():
    import mujoco
    from simulation.mujoco.scripts.visualization.stow_preview import stages_for
