...
from simulation.mujoco.runtime.calculated_placement_preview import CalculatedPlacement, DUTY, PERIOD, STATIC_SHIFT, STRIDE, tilted_pose
from simulation.mujoco.runtime.support_shift import LEGS, SupportShift
from simulation.mujoco.runtime.footstep_tracker import rotation
...
def model():
    ...
    params['foot_cushion'] = json.loads((root/'config/foot_cushion_d37p3_l27mm.json').read_text())
