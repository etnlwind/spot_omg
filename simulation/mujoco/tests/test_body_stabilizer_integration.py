...
from simulation.mujoco.runtime.body_stabilizer import BodyStabilizer, CONFIG
...
def robot():
    ...
    parameters['foot_cushion']=json.loads((root/'config/foot_cushion_d37p3_l27mm.json').read_text())
