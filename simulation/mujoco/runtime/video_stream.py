...
class VideoStream:
    ...
    def publish(self,plant,camera=None):
        ...
        view=(camera.lookat.copy(),camera.distance,camera.azimuth,camera.elevation) if camera else (plant.data.subtree_com[plant.model.body('robot').id]-[0,0,.1],1.05,90.,0.)
