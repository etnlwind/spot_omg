...
root=Path('simulation/mujoco');p=json.load(open(root/'upright_profiles.json'))['profiles']['cushion_wbc'];pad=json.load(open(root/'foot_cushion_d37p3_l27mm.json'));results=[]
