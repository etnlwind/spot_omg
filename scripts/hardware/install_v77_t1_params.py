...
OUT=ROOT/'artifacts/v77-t1/param-install'
OUT.mkdir(parents=True,exist_ok=True)
IMAGE=ROOT/'artifacts/v77-t1/param-firmware/s-native-v6-2-7-v77-t1-param.bin'
HASH='b00caa6223a5eefb19f7ba4d05da90b7d4fe411810f3998d8d0736b4ed15a3c6'
...
def main():
    ...
    try:
        with Stm32Console('SpotOMG-Bridge',transport=BleTransport('SpotOMG-Bridge')) as console:
            ...
            required_revision='rev=s-native-v6-2-7-v77-t1-walk' if args.stage=='prepare' else 'rev=s-native-v6-2-7-v77-t1-param'
            ...
            if args.stage=='prepare':
                ...
                send('probeconfig show');send('probeconfig set 20 344 4000 all');
