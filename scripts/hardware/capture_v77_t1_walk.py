...
def main():
    ...
    ap.add_argument('--revision',default='s-native-v6-2-7-v77-t1-walk')
    ...
    result=dict(lift_mm=20,legs="all",command=[344,0],host_drive_window_s=a.drive_window,automatic_retry=False);worker=None;motion=False
