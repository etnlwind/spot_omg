...
OUT=ROOT/'artifacts/v77-t1/lift-install'
OUT.mkdir(parents=True,exist_ok=True)
IMAGE=ROOT/'artifacts/v77-t1/lift-firmware/s-native-v6-2-7-v77-t1-lift.bin'
HASH='d7b540a7b5c62c6d5017f78de278dabdb04b9d2d4a7ff71ba5b0f860dc18eb0e'
...
def main():
    ...
    try:
        with Stm32Console('SpotOMG-Bridge',transport=BleTransport('SpotOMG-Bridge')) as console:
            ...
            required_revision='rev=s-native-v6-2-7-v77-t1' if args.stage=='prepare' else 'rev=s-native-v6-2-7-v77-t1-lift'
