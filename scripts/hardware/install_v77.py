...
OUT=ROOT/'artifacts/imu-trace-v77/hardware-2026-09-17'
OUT.mkdir(parents=True,exist_ok=True)
IMAGE=ROOT/'artifacts/imu-trace-v77/firmware/s-native-v6-2-7-v77.bin'
HASH='7ba82f3b0ff209d7084204797f19c66ea04cb14b7a99f09a10a855f48dfbea9c'
...
def main():
    ...
    try:
        with Stm32Console('SpotOMG-Bridge',transport=BleTransport('SpotOMG-Bridge')) as console:
            ...
            required_revision='rev=s-native-v6-2-7-v76' if args.stage=='prepare' else 'rev=s-native-v6-2-7-v77'
            ...
            if args.stage=='prepare':
                ...
                send('gaitprofiles');send('profile');send('imutrace status');send('imutrace dump 0 12')
