...
OUT=ROOT/'artifacts/v77-t1/fr-j1-install'
OUT.mkdir(parents=True,exist_ok=True)
IMAGE=ROOT/'artifacts/v77-t1/fr-j1-firmware/s-native-v6-2-7-v77-t1-param-j1.bin'
HASH='6c7e8951907ce58336261f14dde43e8473dc2454b89d0a14716ce0e1491ea48e'
...
def main():
    ...
    try:
        with Stm32Console('SpotOMG-Bridge',transport=BleTransport('SpotOMG-Bridge')) as console:
            ...
            required_revision='rev=s-native-v6-2-7-v77-t1-param' if args.stage=='prepare' else 'rev=s-native-v6-2-7-v77-t1-param-j1'
            ...
            if args.stage=='prepare':
                ...
                send('targets');send('probeconfig show');send('probeconfig set 20 344 4000 all');
                configured=send('probeconfig show')
                assert {'lift_mm=20','linear=344','duration_ms=4000','legs=all'}.issubset(configured.text.split())
