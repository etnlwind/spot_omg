...
class SharedGaitPolicy:
    ...
    def _build_library(cls) -> Path:
        ...
        digest = hashlib.sha256(
            wrapper.read_bytes() + header.read_bytes() + b"".join(header.with_name(name).read_bytes() for name in ("navigation_control.h", "lateral_instep.h", "foot_lift.h", "heading_control.h", "gait_tracking.h", "arc_turn.h", "center_pivot.h", "arc_swing_shape.h", "arc_lift_first.h", "arc_balance.h", "arc_preload.h", "arc_support_shift.h", "arc_attitude.h", "arc_transfer.h", "arc_support.h", "arc_tripod_support.h", "arc_geometry.h", "locomotion.h", "locomotion_profiles.h", "balance_control.h", "drive_control.h", "attitude_control.h", "locomotion_servo.h", "s_native_servo.h", "robot_config.h", "motor_capability.h", "stow_control.h", "pose_control.h")) + (header.parent.parent / "Src" / "robot_config.c").read_bytes()
        ).hexdigest()[:16]
